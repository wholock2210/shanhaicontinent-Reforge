...
public class XiancaoEntity extends Monster {

    private LivingEntity attackTarget = null;
    private int attackCooldown = 0;

    public XiancaoEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(ModEntities.CHRYSANTHEMUM_TRUNCATUM.get(), world);
    }

    public XiancaoEntity(EntityType<XiancaoEntity> type, Level world) {
        super(type, world);
        setMaxUpStep(0.6f);
        xpReward = 0;
        setNoAi(true);
    ...
    public static void init() {
        SpawnPlacements.register(ModEntities.CHRYSANTHEMUM_TRUNCATUM.get(),
