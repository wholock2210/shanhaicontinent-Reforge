...
public class QiluotulipEntity extends Monster {

    private LivingEntity attackTarget = null;
    private int attackCooldown = 0;

    public QiluotulipEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(ModEntities.QILUOTULIP.get(), world);
    }

    public QiluotulipEntity(EntityType<QiluotulipEntity> type, Level world) {
        super(type, world);
        setMaxUpStep(0.6f);
        xpReward = 0;
        setNoAi(true);
    ...
    public static void init() {
        SpawnPlacements.register(ModEntities.QILUOTULIP.get(),
