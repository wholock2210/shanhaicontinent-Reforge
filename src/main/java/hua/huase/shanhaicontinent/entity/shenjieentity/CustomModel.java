...
public class CustomModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("shanhaicontinent", "chrysanthemum_truncatum"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r37 = bone9.addOrReplaceChild("cube_r37", CubeListBuilder.create().texOffs(26, 28).addBox(-1.5F, -1.0F, -7.5F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.0212F, -0.0642F, -0.1309F, 0.0F, 0.0F));

		PartDefinition bone10 = partdefinition.addOrReplaceChild("bone10", CubeListBuilder.create().texOffs(18, 24).addBox(-0.4624F, 0.1687F, -0.1803F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 15.0F, 2.0F, -0.9163F, 0.0F, 0.0873F));
		...
		PartDefinition cube_r39 = bone10.addOrReplaceChild("cube_r39", CubeListBuilder.create().texOffs(22, 26).addBox(0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5376F, 0.1687F, -0.1803F, 0.0F, 0.0F, -0.3491F));
		...
		PartDefinition cube_r45 = bone12.addOrReplaceChild("cube_r45", CubeListBuilder.create().texOffs(2, 29).addBox(-1.0F, -1.0F, -1.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0341F, -6.0367F, 0.4041F, 0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r46 = bone12.addOrReplaceChild("cube_r46", CubeListBuilder.create().texOffs(0, 29).addBox(-1.0F, -1.0F, -1.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0341F, -5.083F, 0.7049F, 0.3054F, 0.0F, 0.0F));
		...
		PartDefinition cube_r52 = bone11.addOrReplaceChild("cube_r52", CubeListBuilder.create().texOffs(10, 28).addBox(0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.7037F, 0.4309F, 1.7522F, 0.3054F, 0.0F, 0.0F));
