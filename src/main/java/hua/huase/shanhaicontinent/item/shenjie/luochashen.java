...
public class luochashen extends WuqiBase {
    public luochashen(Tier tier, int i, float v, Properties properties) {
    ...
    public void appendHoverText(ItemStack itemStack, Level level, List<Component> list, TooltipFlag tooltipFlag) {
        ...
        list.add(Component.translatable("《罗刹神神力》"));
        list.add(Component.translatable("罗刹神简介1"));
        list.add(Component.translatable("罗刹神简介2"));
        list.add(Component.translatable("罗刹神简介3"));
    }
}