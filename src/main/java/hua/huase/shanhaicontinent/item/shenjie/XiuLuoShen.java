...
public class XiuLuoShen extends WuqiBase {
    public XiuLuoShen(Tier tier, int i, float v, Properties properties) {
    ...
    public void appendHoverText(ItemStack itemStack, Level level, List<Component> list, TooltipFlag flag) {
        ...
        list.add(Component.translatable("《修罗神神力》"));
        list.add(Component.translatable("修罗神简介1"));
        list.add(Component.translatable("修罗神简介2"));
        list.add(Component.translatable("修罗神简介3"));
        }
    }