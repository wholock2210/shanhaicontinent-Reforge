...
public class HotyangquanItem extends BucketItem {
    public HotyangquanItem() {
        super(ShanhaicontinentModFluids.HOTYANGQUAN, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).rarity(Rarity.EPIC));
    }
