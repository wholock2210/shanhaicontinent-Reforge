...
public class Jineng_Huang_6 extends JinengBase{
    public Jineng_Huang_6(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        player.getCooldowns().addCooldown(this, (int) (8000-Math.log10(this.getNianxian(player, itemstack))*1000));
        if (!level.isClientSide) {
            player.addEffect(new MobEffectInstance(SHModMobEffectsinit.jineng_huang_6.get(), 2000, 0));
        }
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag) {
        ...
        list.add(Component.translatable("受到致命伤满血复活").withStyle(ChatFormatting.GREEN));
