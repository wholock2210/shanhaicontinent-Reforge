...
public class Jineng_HTSC_6 extends JinengBase{
    public Jineng_HTSC_6(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            player.addEffect(new MobEffectInstance(SHModMobEffectsinit.jineng_htsc_6.get(), 600, 0));
        }
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag) {
        ...
        list.add(Component.translatable("锤影在周身形成一圈能量光罩进行防御").withStyle(ChatFormatting.GREEN));
