...
import hua.huase.shanhaicontinent.entity.jinengentity.haotianchui.Jineng_HTSC_7_Entity;
...
public class Jineng_HTSC_7 extends JinengBase {
    public Jineng_HTSC_7(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        player.getCooldowns().addCooldown(this, (int) (160 - Math.log10(this.getNianxian(player, itemstack)) * 13));
        boolean canBreakBlocks = ModConfig.canBreakBlocks.get();
        if (!level.isClientSide) {
            Jineng_HTSC_7_Entity entity = new Jineng_HTSC_7_Entity(EntityInit.jinenghtsc7.get(), level);
