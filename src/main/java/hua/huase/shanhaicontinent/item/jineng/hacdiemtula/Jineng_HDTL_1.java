...
public class Jineng_HDTL_1 extends JinengBase {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                sword.setPos(player.getX(), player.getEyeY() + 0.7D, player.getZ());
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list,
        ...
        list.add(Component.literal("sát thương dựa vào niên hạn hồn hoàn * 5").withStyle(ChatFormatting.RED));
    }
}
