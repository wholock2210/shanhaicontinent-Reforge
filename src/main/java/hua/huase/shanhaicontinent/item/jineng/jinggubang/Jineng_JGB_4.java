...
public class Jineng_JGB_4 extends JinengBase{
    public Jineng_JGB_4(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        player.getCooldowns().addCooldown(this, (int) (600-Math.log10(this.getNianxian(player, itemstack))*60));
        if (!level.isClientSide) {

            player.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 400, 5));
...
//        }
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag) {
        ...
        list.add(Component.translatable("武魂分出一些魂力可以使自己超速行驶").withStyle(ChatFormatting.GREEN));
