...
public class Jineng_HTSC_3 extends WuqiBase {
    public Jineng_HTSC_3(Tier tier, int i, float v, Properties properties) {
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag) {
        ...
        list.add(Component.translatable("每10级提升5%的物伤、暴击率、爆伤").withStyle(ChatFormatting.GREEN));
