...
public class Jineng_Huang_4 extends JinengBase{
    public Jineng_Huang_4(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        player.getCooldowns().addCooldown(this, (int) (160-Math.log10(this.getNianxian(player, itemstack))*20));
//        player.getCooldowns().addCooldown(this, 10);
        if (!level.isClientSide) {

            JiNengCMJJEntity entity = new JiNengCMJJEntity(EntityInit.jinengcmjj.get(), level);
...
//        }
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag) {
        ...
        list.add(Component.translatable("一株草可斩日月星辰!挑出一剑，对前方大范围敌人伤害").withStyle(ChatFormatting.GREEN));
