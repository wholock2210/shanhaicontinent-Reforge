...
public class Jineng_Huang_8 extends JinengBase{
    public Jineng_Huang_8(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        player.getCooldowns().addCooldown(this, (int) (2000-Math.log10(this.getNianxian(player, itemstack))*200));
        if (!level.isClientSide) {

            player.addEffect(new MobEffectInstance(SHModMobEffectsinit.jineng_huang_8.get(), 1000, 0));
        }
...
//        }
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag) {
        ...
        list.add(Component.translatable("物攻+6666、物防+6666、爆伤+66、爆率+66、回复+666，吸血+66").withStyle(ChatFormatting.GREEN));
