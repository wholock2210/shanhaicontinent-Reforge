...
public class Jineng_Huang_5 extends JinengBase{
    public Jineng_Huang_5(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        player.getCooldowns().addCooldown(this, (int) (9000-Math.log10(this.getNianxian(player, itemstack))*1000));
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag) {
        ...
        list.add(Component.translatable("刷新所有技能冷却").withStyle(ChatFormatting.GREEN));
