...
public class Jineng_JGB_6 extends JinengBase{
    public Jineng_JGB_6(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        player.getCooldowns().addCooldown(this, (int) (1000-Math.log10(this.getNianxian(player, itemstack))*100));
        if (!level.isClientSide) {
            player.addEffect(new MobEffectInstance(SHModMobEffectsinit.jineng_jgb_6.get(), 1000, 2));
        }
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag) {
        ...
        list.add(Component.translatable("自己与破天神棍融为一体，提升自身3000物攻，50%爆伤，20%爆率").withStyle(ChatFormatting.GREEN));
