...
public class SHMainBus {
    ...
    // 寒极冰泉&炽火阳泉 DEBUFF
    public static final ResourceKey<DamageType> COLDICE_DAMAGE = ResourceKey.create(Registries.DAMAGE_TYPE,
            new ResourceLocation("shanhaicontinent", "coldice"));
    public static final ResourceKey<DamageType> HOT_DAMAGE = ResourceKey.create(Registries.DAMAGE_TYPE,
            new ResourceLocation("shanhaicontinent", "hot_yangquan"));

    // protected static final SimpleChannel channel =
    // NetworkRegistry.newSimpleChannel(new
    // ResourceLocation("ep","sync"),()->"340",(s) -> true, (s) -> true);
