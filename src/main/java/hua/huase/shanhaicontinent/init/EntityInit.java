...
import hua.huase.shanhaicontinent.entity.jinengentity.hacdiemtula.Jineng_HDTL_1_Entity;
import hua.huase.shanhaicontinent.entity.jinengentity.hacdiemtula.Jineng_HDTL_1_Render;
...
public class EntityInit {
        public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister
                        .create(ForgeRegistries.ENTITY_TYPES, SHMainBus.MOD_ID);

        // public static final RegistryObject<EntityType<RhinoEntity>> RHINO =
        // ENTITY_TYPES.register("rhino", () -> EntityType.Builder.of(RhinoEntity::new,
        // MobCategory.CREATURE)
        // .sized(2.5f, 2.5f).build("rhino"));
        public static final RegistryObject<EntityType<ProtectionBox>> PROTECTION_BOX = registerEntity(
                        EntityType.Builder.<ProtectionBox>of(ProtectionBox::new, MobCategory.MISC)
                                        .sized(0.5F, 0.5F)
                                        .updateInterval(Integer.MAX_VALUE)
                                        .setCustomClientFactory(ProtectionBox::new),
                        "protection_box");
        ...
        public static final RegistryObject<EntityType<HunhuanEntity>> HUNHUAN = ENTITY_TYPES.register("hunhuan",
                        () -> EntityType.Builder.of(HunhuanEntity::new, MobCategory.MISC)
                                        .updateInterval(Integer.MAX_VALUE)
                                        .sized(1.0f, 1.0f).build("hunhuan"));
        public static final RegistryObject<EntityType<HunheEntity>> HUNHE = ENTITY_TYPES.register("hunhe",
                        () -> EntityType.Builder.of(HunheEntity::new, MobCategory.MISC)
                                        .updateInterval(Integer.MAX_VALUE)
                                        .sized(1.0f, 1.0f).build("hunhe"));
        public static final RegistryObject<EntityType<JinengItemEntity>> JINENGITEM = ENTITY_TYPES
                        .register("jinengitem", () -> EntityType.Builder.of(JinengItemEntity::new, MobCategory.MISC)
                                        .updateInterval(Integer.MAX_VALUE)
                                        .sized(0.5f, 0.5f).build("jinengitem"));

        public static final RegistryObject<EntityType<JiNengFSHYEntity>> jinengfshy = ENTITY_TYPES
                        .register("jinengfshy", () -> EntityType.Builder.of(JiNengFSHYEntity::new, MobCategory.MISC)
                                        .sized(1.0f, 1.0f).build("jinengfshy"));
        public static final RegistryObject<EntityType<JiNengKPBSEntity>> jinengkpbs = ENTITY_TYPES
                        .register("jinengkpbs", () -> EntityType.Builder.of(JiNengKPBSEntity::new, MobCategory.MISC)
                                        .updateInterval(Integer.MAX_VALUE)
                                        .sized(3.0f, 3.0f).build("jinengkpbs"));
        public static final RegistryObject<EntityType<JiNengSNSLEntity>> jinengsnsl = ENTITY_TYPES
                        .register("jinengsnsl", () -> EntityType.Builder.of(JiNengSNSLEntity::new, MobCategory.MISC)
                                        .updateInterval(Integer.MAX_VALUE)
                                        .sized(3.0f, 3.0f).build("jinengsnsl"));
        public static final RegistryObject<EntityType<JiNengCMJJEntity>> jinengcmjj = ENTITY_TYPES
                        .register("jinengcmjj", () -> EntityType.Builder.of(JiNengCMJJEntity::new, MobCategory.MISC)
                                        .updateInterval(Integer.MAX_VALUE)
                                        .sized(3.0f, 3.0f).build("jinengcmjj"));
        public static final RegistryObject<EntityType<JiNengBSQEntity>> jinengbsq = ENTITY_TYPES.register("jinengbsq",
                        () -> EntityType.Builder.of(JiNengBSQEntity::new, MobCategory.MISC)
                                        .updateInterval(Integer.MAX_VALUE)
                                        .sized(8.0f, 8.0f).build("jinengbsq"));
        public static final RegistryObject<EntityType<Jineng_HTSC_1_Entity>> jinenghtsc1 = ENTITY_TYPES
                        .register("jinenghtsc1",
                                        () -> EntityType.Builder.of(Jineng_HTSC_1_Entity::new, MobCategory.MISC)
                                                        .updateInterval(Integer.MAX_VALUE)
                                                        .sized(3.0f, 3.0f).build("jinenghtsc1"));
        
        public static final RegistryObject<EntityType<Jineng_HDTL_1_Entity>> jinenghdtl1 =
        ...
        public static final RegistryObject<EntityType<Jineng_HTSC_7_Entity>> jinenghtsc7 = ENTITY_TYPES
                        .register("jinenghtsc7",
                                        () -> EntityType.Builder.of(Jineng_HTSC_7_Entity::new, MobCategory.MISC)
                                                        .updateInterval(Integer.MAX_VALUE)
                                                        .sized(8.0f, 8.0f).build("jinenghtsc7"));
        // mob

        public static final RegistryObject<EntityType<HunminEntity>> hunmin = ENTITY_TYPES.register("hunmin",
                        () -> EntityType.Builder.of(HunminEntity::new, MobCategory.MONSTER)
                                        .sized(0.6F, 1.95F).clientTrackingRange(20)
                                        .build("hunmin"));
        ...
        public static class ClientModEvents {
                ...
                public static void onClientSetup(FMLClientSetupEvent event) {
                        ...
                        EntityRenderers.register(EntityInit.jinenghdtl1.get(), Jineng_HDTL_1_Render::new);
                ...
                public static void registerLayer(EntityRenderersEvent.RegisterLayerDefinitions event) {
                        ...
                        event.registerLayerDefinition(PROTECTION_BOX,
                                        () -> LayerDefinition.create(ProtectionBoxModel.createMesh(), 16, 16));

                        // event.registerLayerDefinition(ModModelLayers.PINE_BOAT_LAYER,
                        // BoatModel::createBodyModel);
                        // event.registerLayerDefinition(ModModelLayers.PINE_CHEST_BOAT_LAYER,
