...
public class FertileDirtBlock extends SpreadingSnowyDirtBlock implements BonemealableBlock {
    public FertileDirtBlock(BlockBehaviour.Properties p_53685_) {
        super(p_53685_);
    }
    ...
    public void performBonemeal(ServerLevel p_221270_, RandomSource p_221271_, BlockPos p_221272_, BlockState p_221273_) {
        ...
        BlockState blockstate = ModBlock.FERTILE_DIRT.get().defaultBlockState();
